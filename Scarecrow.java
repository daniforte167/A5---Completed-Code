...
class Scarecrow {
   ...
   private String message;
     ...
     */
    public Scarecrow(Pumpkin h, Shirt b, Pants l, Boot lF, Boot rF, String mg) {
        head = h;
        body = b;
        legs = l;
        leftFoot = lF;
...
// TODO: Don't forget to update the line below if you modify the constructor
        Scarecrow myScarecrow = new Scarecrow(new Pumpkin(), new Shirt (), new Pants (), new Boot("left"), new Boot("right"), new String());
